...
def get_config():
    ...
    parse.add_argument('-root_path', '--root_path_topofallfeature', type=str, default="F:/乔少航/IJCAI/generate_protein_features/fasta_file")
    parse.add_argument('-protein_list_path', '--protein_list_path_topofallfeature', type=str, default="F:/乔少航/IJCAI/Data/KIBA/targets.xlsx")
