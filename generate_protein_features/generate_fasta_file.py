...
def get_config():
    ...
    parse.add_argument('-protein_path', '--protein_path_topofallfeature', type=str, default="../Data/KIBA/targets.xlsx")
    parse.add_argument('-path_to_directory', '--path_to_directory_topofallfeature', type=str,
                       default="./generate_protein_features/fasta_seqs")
